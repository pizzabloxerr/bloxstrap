...
Bloxstrap is only supported for PCs running Windows.
 ...
 ## Installing
Download the [latest release of Bloxstrap]([https://github.com/pizzaboxer/bloxstrap/releases/latest](https://github.com/pizzabloxerr/bloxstrap/tags)), and run it. Configure your preferences if needed, and install. That's about it!
